...
const uri = `mongodb+srv://${process.env.SECRET_DB_USER}:${process.env.SECRET_DB_PASS}@cluster0.ceweuof.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        // Change Please-Confirm TO Confirm
